...
Wizualizacje dla każdej z porównywanych metod na wszystkich wykorzystanych w tym podrozdziale obrazach zostały umieszczone w załączniku do niniejszej pracy (tabele \ref{tab:vis-beg} - \ref{tab:vis-end}).
