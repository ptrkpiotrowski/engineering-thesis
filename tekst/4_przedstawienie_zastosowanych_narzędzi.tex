...
Niewątpliwie kluczową rolę w procesie analizy porównawczej algorytmów percepcji głębi odgrywają odpowiednio dobrane zestawy danych. Metody są często testowane przez ich autorów na zbiorach tożsamych do tych na których były uczone. Powoduje to brak oceny zdolności do generalizacji danego algorytmu. W celu uniknięcia tego typu błędów, w niniejszej pracy wykorzystano zestawy danych, które są dostępne publicznie, jednak nie zostały wykorzystane w trenowaniu ani testowaniu żadnego analizowanego algorytmu. 
